...
- The Wave 49 multi-seed balance pass keeps all 12/12 routes complete with 84 samples, timeout risks 0, unsafe spikes 0, and leaves Zhuge Liang's lowest post-combat HP band at `8/10/15` while keeping him a high-strategy pressure character.
